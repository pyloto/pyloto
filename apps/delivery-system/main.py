...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("🚀 Starting Pyloto Delivery System...")
    ...
    logger.info("🎉 Pyloto Delivery System started successfully!")
    
    yield
    
    # Shutdown
    logger.info("🛑 Shutting down Pyloto Delivery System...")


# Create FastAPI app
app = FastAPI(
    title="Pyloto Delivery System",
    description="Sistema de intermediação de entregas com IA integrada",
    version="1.0.0",
